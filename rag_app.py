...
# Your imports from Colab remain
...
# --- Load your model and vector store (do this only ONCE at startup) ---
...
loader = PyPDFLoader("hotelwinwin_details.pdf")  # Make sure file is present!
docs = loader.load()
...
async def chat_endpoint(request: QueryRequest):
    answer = get_user_friendly_response(request.question)
